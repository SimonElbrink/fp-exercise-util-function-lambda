...
public class Exercises {
    ...
    */
    public static void exercise1(String message) {
        ...
        storage.findMany(p -> Objects.equals(p.getFirstName(), "Erik"))
    ...
    public static void exercise3(String message) {
        ...
        storage.findMany(person -> person.getBirthDate().isAfter(LocalDate.parse("1999-12-31")))
                .forEach(System.out::println);
    ...
    public static void exercise5(String message) {
        ...
        System.out.println(
                storage.findOneAndMapToString(
                        person -> Objects.equals(person.getId(), 456),
    ...
    public static void exercise13(String message) {
        ...
        //With Anonymous inner Class - For Demonstration
        ...
        //Stack together
        Comparator<Person> combinedCompare = compareLastName.thenComparing(compareFirstName).thenComparing(compareBirthDate);

        storage.findAndSort(combinedCompare).forEach(System.out::println);
